...
public class LumpDistributionSerializer extends Serializer<LumpDistribution> {
    public LumpDistributionSerializer() {
        super(false, false);
    }

    @Override
    public LumpDistribution copy(Kryo kryo, LumpDistribution original) {
        return original.copy();
    }

    @Override
    public void write(Kryo kryo, Output output, LumpDistribution object) {
    ...
    @Override
    public LumpDistribution read(Kryo kryo, Input input, Class<? extends LumpDistribution> type) {
        return new LumpDistribution((EnhancedRandom) kryo.readClassAndObject(input),
