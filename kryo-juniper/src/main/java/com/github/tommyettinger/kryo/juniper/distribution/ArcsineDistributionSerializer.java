...
public class ArcsineDistributionSerializer extends Serializer<ArcsineDistribution> {
    public ArcsineDistributionSerializer() {
        super(false, false);
    }

    @Override
    public ArcsineDistribution copy(Kryo kryo, ArcsineDistribution original) {
        return original.copy();
    }

    @Override
    public void write(Kryo kryo, Output output, ArcsineDistribution object) {
    ...
    @Override
    public ArcsineDistribution read(Kryo kryo, Input input, Class<? extends ArcsineDistribution> type) {
        return new ArcsineDistribution((EnhancedRandom) kryo.readClassAndObject(input),
