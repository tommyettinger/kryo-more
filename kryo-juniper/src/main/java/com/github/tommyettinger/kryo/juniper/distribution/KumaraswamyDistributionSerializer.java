...
public class KumaraswamyDistributionSerializer extends Serializer<KumaraswamyDistribution> {
    public KumaraswamyDistributionSerializer() {
        super(false, false);
    }

    @Override
    public KumaraswamyDistribution copy(Kryo kryo, KumaraswamyDistribution original) {
        return original.copy();
    }

    @Override
    public void write(Kryo kryo, Output output, KumaraswamyDistribution object) {
    ...
    @Override
    public KumaraswamyDistribution read(Kryo kryo, Input input, Class<? extends KumaraswamyDistribution> type) {
        return new KumaraswamyDistribution((EnhancedRandom) kryo.readClassAndObject(input),
