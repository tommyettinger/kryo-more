...
public class LogNormalDistributionSerializer extends Serializer<LogNormalDistribution> {
    public LogNormalDistributionSerializer() {
        super(false, false);
    }

    @Override
    public LogNormalDistribution copy(Kryo kryo, LogNormalDistribution original) {
        return original.copy();
    }

    @Override
    public void write(Kryo kryo, Output output, LogNormalDistribution object) {
    ...
    @Override
    public LogNormalDistribution read(Kryo kryo, Input input, Class<? extends LogNormalDistribution> type) {
        return new LogNormalDistribution((EnhancedRandom) kryo.readClassAndObject(input),
