...
public class CauchyDistributionSerializer extends Serializer<CauchyDistribution> {
    public CauchyDistributionSerializer() {
        super(false, false);
    }

    @Override
    public CauchyDistribution copy(Kryo kryo, CauchyDistribution original) {
        return original.copy();
    }

    @Override
    public void write(Kryo kryo, Output output, CauchyDistribution object) {
    ...
    @Override
    public CauchyDistribution read(Kryo kryo, Input input, Class<? extends CauchyDistribution> type) {
        return new CauchyDistribution((EnhancedRandom) kryo.readClassAndObject(input),
