...
public class LogCauchyDistributionSerializer extends Serializer<LogCauchyDistribution> {
    public LogCauchyDistributionSerializer() {
        super(false, false);
    }

    @Override
    public LogCauchyDistribution copy(Kryo kryo, LogCauchyDistribution original) {
        return original.copy();
    }

    @Override
    public void write(Kryo kryo, Output output, LogCauchyDistribution object) {
    ...
    @Override
    public LogCauchyDistribution read(Kryo kryo, Input input, Class<? extends LogCauchyDistribution> type) {
        return new LogCauchyDistribution((EnhancedRandom) kryo.readClassAndObject(input),
