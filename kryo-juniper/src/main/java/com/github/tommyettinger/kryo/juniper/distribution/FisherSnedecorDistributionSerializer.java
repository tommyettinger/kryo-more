...
public class FisherSnedecorDistributionSerializer extends Serializer<FisherSnedecorDistribution> {
    public FisherSnedecorDistributionSerializer() {
        super(false, false);
    }

    @Override
    public FisherSnedecorDistribution copy(Kryo kryo, FisherSnedecorDistribution original) {
        return original.copy();
    }

    @Override
    public void write(Kryo kryo, Output output, FisherSnedecorDistribution object) {
    ...
    @Override
    public FisherSnedecorDistribution read(Kryo kryo, Input input, Class<? extends FisherSnedecorDistribution> type) {
        return new FisherSnedecorDistribution((EnhancedRandom) kryo.readClassAndObject(input),
