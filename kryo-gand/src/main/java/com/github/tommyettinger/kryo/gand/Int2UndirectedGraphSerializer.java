...
/**
 * Kryo {@link Serializer} for gand {@link Int2UndirectedGraph}s.
 * You must have {@link PointI2} registered to use this as the serializer for Int2UndirectedGraph.
 */
public class Int2UndirectedGraphSerializer extends Serializer<Int2UndirectedGraph> {

    public Int2UndirectedGraphSerializer() {
        setAcceptsNull(false);
    }

    @Override
    public void write(final Kryo kryo, final Output output, final Int2UndirectedGraph data) {
    ...
    @Override
    public Int2UndirectedGraph read(final Kryo kryo, final Input input, final Class<? extends Int2UndirectedGraph> dataClass) {
        Int2UndirectedGraph graph = new Int2UndirectedGraph();
    ...
    @Override
    public Int2UndirectedGraph copy(Kryo kryo, Int2UndirectedGraph original) {
        Int2UndirectedGraph graph = new Int2UndirectedGraph();
