...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-digital is currently version 0.6.0.1
  - kryo-jdkgdxds is currently version 1.7.2.1
...
```gradle
implementation "com.github.tommyettinger:kryo-digital:0.6.0.1"
```

kryo-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:1.7.2.1"
```
