...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-digital is currently version 0.9.3.1
  - kryo-jdkgdxds is currently version 1.12.3.1
  - kryo-juniper is currently version 0.8.3.1
  ...
  - kryo-gand is currently version 0.3.4.1
...
```gradle
implementation "com.github.tommyettinger:kryo-digital:0.9.3.1"
```

kryo-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:1.12.3.1"
```

kryo-juniper:

```gradle
implementation "com.github.tommyettinger:kryo-juniper:0.8.3.1"
```
...
```gradle
implementation "com.github.tommyettinger:kryo-gand:0.3.4.1"
```
