...
Each sub-library has its own version, linked to the version of the library it de/serializes.
  ...
  - kryo-jdkgdxds is currently version 1.2.1.0
...
```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:1.2.1.0"
```

kryo-juniper:

```gradle
implementation "com.github.tommyettinger:kryo-juniper:0.2.0.0"
```
