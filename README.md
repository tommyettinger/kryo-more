...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-libgdx is currently at version 1.14.1.1
  - kryo-regexodus is currently version 0.1.21.1
  - kryo-digital is currently version 0.10.0.1
  - kryo-jdkgdxds is currently version 2.1.3.1
  - kryo-juniper is currently version 0.10.2.1
...
```gradle
implementation "com.github.tommyettinger:kryo-libgdx:1.14.1.1"
```
...
```gradle
implementation "com.github.tommyettinger:kryo-digital:0.10.0.1"
```

kryo-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:2.1.3.1"
```

kryo-juniper:

```gradle
implementation "com.github.tommyettinger:kryo-juniper:0.10.2.1"
```
