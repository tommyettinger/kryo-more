...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-digital is currently version 0.9.9.1
  - kryo-jdkgdxds is currently version 1.14.1.1
  - kryo-juniper is currently version 0.8.6.1
...
```gradle
implementation "com.github.tommyettinger:kryo-regexodus:0.1.20.1"
```

kryo-digital:

```gradle
implementation "com.github.tommyettinger:kryo-digital:0.9.9.1"
```

kryo-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:1.14.1.1"
```

kryo-juniper:

```gradle
implementation "com.github.tommyettinger:kryo-juniper:0.8.6.1"
```
