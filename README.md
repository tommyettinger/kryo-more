...
[gand](https://github.com/tommyettinger/gand), [gdcrux](https://github.com/tommyettinger/gdcrux),
...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-regexodus is currently version 0.1.18.1
  - kryo-digital is currently version 0.6.2.1
  - kryo-jdkgdxds is currently version 1.8.1.1
  - kryo-juniper is currently version 0.6.6.1
...
```gradle
implementation "com.github.tommyettinger:kryo-regexodus:0.1.18.1"
```
...
```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:1.8.1.1"
```

kryo-juniper:

```gradle
implementation "com.github.tommyettinger:kryo-juniper:0.6.6.1"
```
