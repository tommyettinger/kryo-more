...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-digital is currently version 0.5.1.0
  - kryo-jdkgdxds is currently version 1.6.3.0
...
```gradle
implementation "com.github.tommyettinger:kryo-digital:0.5.1.0"
```

kryo-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:`1.6.3.0`"
```
