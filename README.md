...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-jdkgdxds is currently version 1.5.3.0
  - kryo-juniper is currently version 0.6.0.0
...
```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:1.5.3.0"
```

kryo-juniper:

```gradle
implementation "com.github.tommyettinger:kryo-juniper:0.6.0.0"
```
