...
or if Kryo itself had a (compatible) update available but the linked library did not have an update.
  ...
  - kryo-digital is currently version 0.9.7.1
...
```gradle
implementation "com.github.tommyettinger:kryo-digital:0.9.7.1"
```

kryo-jdkgdxds:

```gradle
implementation "com.github.tommyettinger:kryo-jdkgdxds:1.13.1.1"
```

kryo-juniper:

```gradle
implementation "com.github.tommyettinger:kryo-juniper:0.8.5.1"
```
