...
/**
 * Kryo {@link Serializer} for libGDX {@link ArrayMap}s.
 */
public class ArrayMapSerializer extends Serializer<ArrayMap> {
    ...
    @Override
    public void write(final Kryo kryo, final Output output, final ArrayMap data) {
    ...
    @Override
    public ArrayMap<?,?> read(final Kryo kryo, final Input input, final Class<? extends ArrayMap> dataClass) {
