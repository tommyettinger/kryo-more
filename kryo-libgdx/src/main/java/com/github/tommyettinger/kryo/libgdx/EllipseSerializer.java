...
/**
 * Kryo {@link Serializer} for libGDX {@link Ellipse}s.
 */
public class EllipseSerializer extends Serializer<Ellipse> {
    ...
    @Override
    public void write(final Kryo kryo, final Output output, final Ellipse data) {
    ...
    @Override
    public Ellipse read(final Kryo kryo, final Input input, final Class<? extends Ellipse> dataClass) {
